...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({EntityNotFoundException.class, InvalidBankingUserException.class})
    protected ResponseEntity<ErrorResponse> handleNotFoundException(SimpleBankingGlobalException e, Locale locale) {
    ...
    protected ResponseEntity<ErrorResponse> handleUserAlreadyRegisteredException(UserAlreadyRegisteredException e, Locale locale) {
        return ResponseEntity
