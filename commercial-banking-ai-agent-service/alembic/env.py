"""
Alembic environment configuration for the AI Agent Service.
Connects Alembic to the SQLAlchemy models and database engine.
"""
...
# Override the sqlalchemy.url from app settings (environment-aware)
