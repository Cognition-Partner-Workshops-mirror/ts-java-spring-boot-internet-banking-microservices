...
public class TransactionService {
    ...
    public UtilityPaymentResponse utilPayment(UtilityPaymentRequest utilityPaymentRequest) {
        ...
        // Debit the payment amount from both balances — update actualBalance first,
        // then sync availableBalance to match (previously availableBalance was double-subtracted)
    ...
    public String internalFundTransfer(BankAccount fromBankAccount, BankAccount toBankAccount, BigDecimal amount) {
        ...
        // Debit the transfer amount from sender — update actualBalance first,
        // then sync availableBalance to match (previously availableBalance was double-subtracted)
        ...
        // Credit the transfer amount to receiver — update actualBalance first,
        // then sync availableBalance to match (previously availableBalance was double-added)
